...
__version__: Final = "1.2.2"

# --------------------------------------------------------------------------------
# Core Integration Constants
# --------------------------------------------------------------------------------
DOMAIN: Final = "hdg_boiler"  # The domain of the integration.
DEFAULT_NAME: Final = "HDG Boiler"  # Default name for the integration.
MANUFACTURER: Final = "HDG Bavaria GmbH"  # Manufacturer of the boiler.
MODEL_PREFIX: Final = "HDG"  # Prefix for device models.


# --------------------------------------------------------------------------------
# Configuration Keys (used in config flows and options)
# --------------------------------------------------------------------------------
CONF_DEVICE_ALIAS: Final = "device_alias"  # User-defined alias for the device.
CONF_HOST_IP: Final = "host_ip"  # IP address of the HDG boiler.
CONF_SOURCE_TIMEZONE: Final = "source_timezone"  # Timezone for parsing datetimes.
CONF_API_TIMEOUT: Final = "api_timeout"  # General API timeout.
CONF_CONNECT_TIMEOUT: Final = "connect_timeout"  # Connection-specific timeout.
CONF_POLLING_PREEMPTION_TIMEOUT: Final = "polling_preemption_timeout"  # Timeout for low-priority polls when a high-priority one is pending.
CONF_RECENTLY_SET_POLL_IGNORE_WINDOW_S: Final = "recently_set_poll_ignore_window_s"  # Time window to ignore updates for recently set values.
CONF_LOG_LEVEL: Final = "log_level"  # Basic logging level.
CONF_ADVANCED_LOGGING: Final = "advanced_logging"  # Toggle for detailed loggers.
CONF_LOG_LEVEL_THRESHOLD_FOR_CONNECTION_ERRORS: Final = "log_level_threshold_for_connection_errors"  # Number of failures before logging connection errors as ERROR.
...
DEFAULT_API_TIMEOUT: Final = 15  # Default seconds for general API timeout.
MIN_API_TIMEOUT: Final = 5
MAX_API_TIMEOUT: Final = 120

DEFAULT_CONNECT_TIMEOUT: Final = 5.0  # Default seconds for connection timeout.
...
# Polling
DEFAULT_RECENTLY_SET_POLL_IGNORE_WINDOW_S: Final[float] = (
    10.0  # Default time window to ignore updates for recently set values.
)
MIN_RECENTLY_SET_POLL_IGNORE_WINDOW_S: Final[float] = 5.0
MAX_RECENTLY_SET_POLL_IGNORE_WINDOW_S: Final[float] = 30.0

# Logging
DEFAULT_LOG_LEVEL: Final = "INFO"  # Default logging level.
DEFAULT_ADVANCED_LOGGING: Final = False  # Default for advanced logging.
...
HDG_DATETIME_SPECIAL_TEXT: Final = (
...
# --------------------------------------------------------------------------------
# Timing & Delays
INITIAL_REFRESH_API_TIMEOUT_OVERRIDE: Final = (
    30.0  # A more generous timeout for the very first data refresh.
)
POST_INITIAL_REFRESH_COOLDOWN_S: Final = (
    5.0  # Cooldown period after the initial full data refresh.
)
INITIAL_SEQUENTIAL_INTER_GROUP_DELAY_S: Final = (
    0.5  # Short delay between fetching polling groups during initial refresh.
)
SET_NODE_COOLDOWN_S: Final = (
    2.0  # Cooldown period after setting a value before next poll.
)
DEFAULT_SET_VALUE_DEBOUNCE_DELAY_S: Final = (
    2.0  # Default debounce delay for setting values to bundle rapid changes.
)

# Scan Intervals
MIN_SCAN_INTERVAL: Final = 15  # Minimum allowable scan interval in seconds.
MAX_SCAN_INTERVAL: Final = 86430  # Maximum allowable scan interval.
...
ATTR_NODE_ID: Final = "node_id"  # Attribute for node ID in service calls.
ATTR_VALUE: Final = "value"  # Attribute for value in service calls.
...
DIAGNOSTICS_REDACTED_PLACEHOLDER: Final = "REDACTED"  # Placeholder for redacted data.
